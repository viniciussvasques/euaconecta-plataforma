...
// Partners serão carregados do banco de dados
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            contactPoint: {
              '@type': 'ContactPoint',
              telephone: customization.contact?.phone || '+1-555-123-4567',
              contactType: 'customer service',
            },
            sameAs: [
              customization.socialMedia?.instagram || 'https://www.instagram.com/euaconecta',
              customization.socialMedia?.facebook || 'https://www.facebook.com/euaconecta',
            ],
          }),
        }}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <Link
                  href={customization.landingPage?.hero?.ctaLink || "/auth/register"}
                ...
                >
                  {customization.landingPage?.hero?.ctaText || "Começar Agora"}
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-8 leading-tight">
                {customization.landingPage?.hero?.title || "Compre nos Estados Unidos e receba no Brasil"}
              </h1>
              <p className="text-xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
                {customization.landingPage?.hero?.subtitle || "Nike, Adidas, Amazon, Best Buy, Apple e muito mais! Receba seus produtos de qualquer loja americana em nosso endereço, consolide múltiplos pacotes em uma única remessa e economize até 70% no frete internacional."}
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
                ...
                >
                  {customization.landingPage?.hero?.ctaText || "Começar Gratuitamente"}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">{customization.contact?.phone || "+55 (11) 99999-9999"}</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">{customization.contact?.email || "contato@euaconecta.com"}</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">{customization.contact?.address || "São Paulo, SP - Brasil"}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex justify-center space-x-6">
              {customization.socialMedia?.whatsapp && (
                <a
                  href={customization.socialMedia.whatsapp}
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              {customization.socialMedia?.facebook && (
                <a
                  href={customization.socialMedia.facebook}
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              {customization.socialMedia?.instagram && (
                <a
                  href={customization.socialMedia.instagram}
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <div className="space-y-2 text-gray-400">
                  <p>{customization.contact?.phone || "+55 (11) 99999-9999"}</p>
                  <p>{customization.contact?.email || "contato@euaconecta.com"}</p>
                  <p>{customization.contact?.address || "São Paulo, SP - Brasil"}</p>
                </div>
              </div>
            </div>
